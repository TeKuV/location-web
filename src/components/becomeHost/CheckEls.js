...
const CustomCheckBox = ({typo, datas, setDatas}) => {
    ...
    return (
        <FormControlLabel sx={{width: 310,}} control={<Checkbox disableFocusRipple disableTouchRipple size={'medium'} sx={{ color: 'common.black' }} checked={checked} onChange={(event) => handleChange(event.target.checked, typo.label)} />} label={
            <>
