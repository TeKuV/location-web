    ...
    return (
        <Paper sx={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', m: 1, p: 1, flexGrow: 1}} elevation={3}>
            <Box sx={{textAlign: 'center', width: '100%'}}>
                ...
                <Button variant={'contained'} sx={{textTransform: 'none', bgcolor: 'secondary.main', width: '90%', py: 1.5, my: 1}} fullWidth onClick={handleBook}>
                ...
                <Box sx={{display: 'flex', flexGrow: 1, width: '100%', p: 1, my: 1}}>
                    ...
                    <Box sx={{
                        ...
                        <Typography sx={{fontWeight: 'bold'}}>2000 Fcfa</Typography>
                    </Box>
                </Box>
